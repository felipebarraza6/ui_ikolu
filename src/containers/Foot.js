    ...
    return (
      <Row>
        ...
        <Col style={{ marginTop: "30px" }}>
          ...
          <TitleTy style={{ marginLeft: "20px", marginTop: "-10px" }} level={5}>
            Agua de pozo: 33.982 M3
          </TitleTy>
          <TitleTy style={{ marginLeft: "20px", marginTop: "-10px" }} level={5}>
            Agua potable: 14.00 M3
          </TitleTy>
        </Col>
      </Row>
    );
    ...
    return (
      <Row>
        ...
        <Col span={6} style={{ marginRight: "30px" }}>
          <center>
            <TitleTy level={3}>Huella Cliente</TitleTy>
            <img src={truck} width="80%" />
          </center>
          <center>
            <div
              style={{
        ...
        <Col span={6} style={{ marginLeft: "-60px" }}>
          <center>
            <TitleTy level={3}>Huella Mundial</TitleTy>
            <img src={planet} width="80%" />
          </center>
          <center>
            <div
              style={{
