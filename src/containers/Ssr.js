...
const Ssr = () => {
  ...
  const Well = () => {
    return (
      <Row>
        <Col span={5}>
          <TitleTy level={2}>Mi Punto de Captación</TitleTy>
        </Col>
    ...
    return (
      <Row>
        ...
        <Col style={{ marginLeft: "20px", marginTop: "20px" }}>
          <Input
            style={{ width: "250px" }}
            placeholder="Ingresa el total de litros facturados..."
          />
        </Col>
        <Col style={{ marginLeft: "20px", marginTop: "20px" }}>
          <Button
    ...
    >
      <Col style={{ paddingTop: "30px", paddingLeft: "40px" }} span={16}>
        <TitleTy level={3} style={{ color: "white" }}>
          Monitoreo Servicios Sanitarios Rurales (SSR)
        </TitleTy>
      </Col>
