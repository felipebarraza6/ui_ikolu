    ...
    return (
      <Row>
        ...
        <Col span={13} offset={17} style={{ marginTop: "-50px" }}>
          <Countdown
            format="HH:mm:ss:SSS"
            title="Tiempo para Sincronización"
            value={deadline}
        ...
        <Col span={12} style={{ marginLeft: "-40px" }}>
          ...
          >
            <Row align="middle">
              ...
              <Col span={12}>
                <TitleTy level={5} style={{ color: "#222221" }}>
                  Caudal
                </TitleTy>
              </Col>
    ...
    return (
      <Row>
        <Col span={24} style={{ marginBottom: "40px" }}>
          <TitleTy level={2}>
            Últimos datos enviados a la DGA {new Date().getDate()} -{" "}
        ...
        <Col span={12}>
          <center>
            <img style={{ marginTop: "50px" }} src={qr} width={"250px"} />
          </center>
          <center>
            <Button
              onClick={() =>
                window.open(
                  "https://snia.mop.gob.cl/cExtracciones2/#/consultaExtraccionesDia"
                )
              }
              style={{
                marginTop: "20px",
  ...
  return (
    ...
    >
      <Col style={{ paddingTop: "30px", paddingLeft: "40px" }} span={12}>
        <TitleTy level={3} style={{ color: "white" }}>
          Monitoreo Extracciones Efectivas (DGA)
        </TitleTy>
      </Col>
        ...
        <Card style={{ borderRadius: "30px 30px 0px 0px" }}>
          <Row>
            <Col span={3} style={{ paddingRight: "10px" }}>
              <Card
                hoverable={true}
                style={{ backgroundColor: "#1F3461", borderRadius: "20px" }}
              >
                <center>
                  <img
                    src={logo}
            ...
            <Col span={4}>
              <Card
                ...
                style={{ backgroundColor: "#1F3461", borderRadius: "20px" }}
              >
                <TitleTy align="center" style={{ color: "white" }} level={3}>
                  POZO 4
                </TitleTy>
                <TitleTy
                  align="center"
