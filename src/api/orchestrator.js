...
export const tickets = {
  ...
  changeStatus: (id, status, workOrderCategory) => sh.tickets.changeStatus(id, status, workOrderCategory),
  ...
  deleteComment: (ticketId, commentId) => sh.tickets.deleteComment(ticketId, commentId),
  updateComment: (ticketId, commentId, data) => sh.tickets.updateComment(ticketId, commentId, data),
  likeComment: (ticketId, commentId) => sh.tickets.likeComment(ticketId, commentId),
  getMentionableUsers: (ticketId) => sh.tickets.getMentionableUsers(ticketId),
  getNotifications: (params) => sh.tickets.getNotifications(params),
  markNotificationsRead: (data) => sh.tickets.markNotificationsRead(data),
  getAttachments: (id) => sh.tickets.getAttachments(id),
  uploadAttachment: (id, file) => sh.tickets.uploadAttachment(id, file),
  uploadCommentAttachment: (ticketId, commentId, file) => sh.tickets.uploadCommentAttachment(ticketId, commentId, file),
  tasks: {
    get: (id, page) => sh.tickets.tasks.get(id, page),
    getById: (id) => sh.tickets.tasks.getById(id),
    create: (id, data) => sh.tickets.tasks.create(id, data),
    update: (id, data) => sh.tickets.tasks.update(id, data),
    delete: (id) => sh.tickets.tasks.delete(id),
    uploadAttachment: (id, file) => sh.tickets.tasks.uploadAttachment(id, file),
  },
  files: (params) => sh.tickets.files(params),
